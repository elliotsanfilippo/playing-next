...
export default function StatCard({
  ...
  return (
    <div className="group rounded-card border border-white/5 bg-zinc-900/70 p-6 transition duration-300 hover:-translate-y-1 hover:border-white/10 hover:bg-zinc-900">
