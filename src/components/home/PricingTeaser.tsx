    ...
    <section className="relative z-10 px-5 py-14 sm:px-6 sm:py-16 lg:px-8">
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          <h2 className="mt-3 text-[1.75rem] font-bold tracking-tight text-balance sm:mt-4 sm:text-5xl">
            Simple, honest pricing
          </h2>

          <p className="mx-auto mt-3 max-w-sm text-[0.95rem] leading-6 text-zinc-400 sm:mt-4 sm:max-w-lg sm:text-base">
            No hidden fees. Pick the plan that fits how often you take
            requests.
          </p>
        </motion.div>

        <div className="mt-8 grid gap-3 sm:mt-10 sm:gap-5 sm:grid-cols-2">
          <motion.div
            initial={shouldReduceMotion ? false : { opacity: 0, y: 20, scale: 0.96 }}
            whileInView={{ opacity: 1, y: 0, scale: 1 }}
            viewport={{ once: true, margin: "-60px" }}
            transition={{ duration: 0.45, ease: [0.34, 1.4, 0.64, 1] }}
            className="rounded-card-lg border border-white/10 bg-zinc-900/40 p-5 backdrop-blur-md sm:p-8"
          >
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-card-lg border border-accent/30 bg-accent/[0.04] p-5 shadow-[0_0_60px_-20px_rgba(74,222,128,0.35)] backdrop-blur-md sm:p-8"
          >
            <div
              aria-hidden
