export default function EmptySearchState() {
  return (
    <div className="mt-8 rounded-[28px] border border-dashed border-white/10 bg-white/[0.02] p-10 text-center">
      ...
      <p className="mx-auto mt-3 max-w-sm leading-7 text-zinc-500">
        Millions of tracks are available through Spotify.
        Start typing above to begin.
      </p>
    </div>
  );
}