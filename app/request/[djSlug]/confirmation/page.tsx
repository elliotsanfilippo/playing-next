  ...
  return (
    <main className="min-h-screen bg-black p-5 text-white sm:p-6">
      <section className="mx-auto flex min-h-screen max-w-2xl items-center justify-center">
        <div className="w-full rounded-3xl border border-green-500/20 bg-zinc-900 p-6 text-center sm:p-8">
          ...
          <div className="mt-8 rounded-2xl border border-green-500/20 bg-green-500/10 p-5 sm:p-6">
          ...
          <div className="mt-6 rounded-2xl border border-white/10 bg-zinc-950 p-5 sm:p-6">
